...
class KeyringController extends EventEmitter {
     ...
     *
     * Signs an Velas transaction object.
     *
     * @param {Object} velasTx - The transaction to sign.
     * @param {Object} web3 - web3 object.
     * @returns {string} The signed transaction raw string.
     */

    async signTransaction(velasTx, privateKey) {
        const tx = new Tx(velasTx);
    ...
    async getFees(velasTx, web3) {
        const { from, to, value, data, gasLimit } = velasTx
